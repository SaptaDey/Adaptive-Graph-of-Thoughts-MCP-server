...
async def nlq_endpoint(payload: Dict[str, str] = Body(...)) -> StreamingResponse:
    """Translate a natural language question to Cypher, execute it, and stream results."""
    ...
    async def event_stream() -> AsyncGenerator[bytes, None]:
        ...
        summary_prompt = (
            f"Answer the question '{question}' using this data: {rows}." " Respond in under 50 words."
        )
