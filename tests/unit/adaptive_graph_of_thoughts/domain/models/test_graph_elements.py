...
def canonical_elem():
    """
    Provides a reusable canonical GraphElement instance with fixed attributes.
    
    Returns:
        A GraphElement with node_id set to UUID(int=0), label "canonical", and weight 1.0.
    """
...
class TestGraphElementConstruction:
    ...
    def test_happy_path(self, node_id, label, weight):
        ...
        Asserts that the instance attributes match the provided input values.
        """
...
class TestGraphElementEdgeCases:
    ...
    def test_edge_values(self, label, weight):
        """
        Tests that GraphElement correctly stores edge-case values for label and weight.
        
        Verifies that the label and weight attributes are set as provided, including for empty strings, very long strings, Unicode labels, zero, and extreme float values.
        """
...
class TestGraphElementInvalidInputs:
    ...
    def test_invalid_inputs(self, node_id, label, weight):
        ...
        Attempts to create a GraphElement using the provided node_id, label, and weight, and asserts that a ValueError or TypeError is raised for invalid input combinations.
        """
...
class TestGraphElementEqualityHashing:
    ...
    def test_inequality(self):
        """
        Verifies that GraphElement instances with the same node_id and weight but different labels are not equal.
        """
...
class TestGraphElementRepresentation:
    ...
    def test_repr_contains_class_and_id(self):
        """
        Tests that the repr() output of a GraphElement includes the class name and node UUID.
        """
        uid = uuid.uuid4()
...
class TestGraphElementSerialization:
    ...
    def test_dict_round_trip(self):
        ...
        Skips the test if the GraphElement class does not implement both to_dict and from_dict methods.
        """
...
class TestGraphElementFixture:
    ...
    def test_canonical_attributes(self, canonical_elem):
        """
        Verifies that the canonical GraphElement fixture has the expected attribute types and values.
        """
