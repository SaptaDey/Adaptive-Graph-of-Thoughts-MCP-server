...
class TestGraphElementConstruction:
    ...
    def test_happy_path(self, node_id, label, weight):
        """
        Tests that a GraphElement is correctly constructed with valid node_id, label, and weight.
        
        Asserts that the object's attributes match the provided input values.
        """
...
class TestGraphElementFixture:
    ...
    def test_canonical_attributes(self, canonical_elem):
        """
        Verifies that the canonical_elem fixture has the expected attribute types and values.
        """
