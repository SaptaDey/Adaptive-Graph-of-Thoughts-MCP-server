...
class TestGraphElementConstruction:
    ...
    def test_happy_path(self, node_id, label, weight):
        ...
        Verifies that the attributes of the created GraphElement match the provided input values.
        """
...
class TestGraphElementEdgeCases:
    ...
    def test_edge_values(self, label, weight):
        ...
        Verifies that the label and weight attributes match the provided edge-case inputs.
        """
...
class TestGraphElementInvalidInputs:
    ...
    def test_invalid_inputs(self, node_id, label, weight):
        """
        Tests that initializing GraphElement with invalid node_id, label, or weight raises ValueError or TypeError.
        """
...
class TestGraphElementRepresentation:
    ...
    def test_repr_contains_class_and_id(self):
        """
        Tests that the repr() output of a GraphElement includes the class name and node_id.
        """
        uid = uuid.uuid4()
...
class TestGraphElementSerialization:
    ...
    def test_json_round_trip(self):
        """
        Tests that serializing and deserializing a GraphElement using JSON preserves equality.
        
        Verifies that converting a GraphElement to JSON and back using from_json and to_json
