...
class TestSettings:  # Test class name can remain, or change to TestConfigOldSchema if desired
    ...
    def test_settings_equality(self):
        ...
        assert (
            config1 == config2
        )  # This should pass as they are identical default configs
...
class TestConfig:
    ...
    def test_config_load_from_environment(self):
        ...
        with patch.dict(
            os.environ,
            {"LEARNING_RATE": "0.02", "BATCH_SIZE": "64", "MAX_STEPS": "2000"},
        ):
...
class TestConfigEdgeCases:
    ...
    def test_config_very_large_values(self):
        ...
        config = Config(learning_rate=0.01, batch_size=1000000, max_steps=999999999)
...
class TestConfigProperties:
    ...
    def test_config_valid_combinations(self, learning_rate, batch_size, max_steps):
        ...
        config = Config(
            learning_rate=learning_rate, batch_size=batch_size, max_steps=max_steps
        )
